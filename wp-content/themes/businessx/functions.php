...
// top sidebars
		register_sidebar( array( // top #1 sidebar
			'name'          => __( 'top #1 Sidebar', 'businessx' ),
			'id'            => 'sidebar-top-1',
			'description'   => __( 'First top sidebar', 'businessx' ),
			'before_widget' => '<div id="widget-block" class="me-widget clearfix">',
			'after_widget'  => '</div><!-- END .widget -->',
			'before_title'  => '<h3 class="widget-title hs-secondary-smallest ls-min"><span>',
			'after_title'   => '</span></h3>',
		) );//latest news
		register_sidebar( array( // top #1 sidebar
			'name'          => __( 'News', 'businessx' ),
			'id'            => 'sidebar-news-1',
			'description'   => __( 'First top sidebar', 'businessx' ),
			'before_widget' => '<div id="widget-block" class="me-widget clearfix">',
			'after_widget'  => '</div><!-- END .widget -->',
