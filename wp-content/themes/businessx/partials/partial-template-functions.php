...
// -- top Sidebar #1
if ( ! function_exists( 'businessx_top_sidebar_1' ) ) {
	function businessx_top_sidebar_1() {
		?>
			<?php
            do_action( 'businessx_top_sidebar__1_top' );

                // Display widgets
                if ( is_active_sidebar( 'sidebar-top-1' ) ) {
                    dynamic_sidebar( 'sidebar-top-1' );
                }
            do_action( 'businessx_top_sidebar__1_bottom' );
            ?>
        <?php
	}
}
