...
/* -- Header Main Wrapper */
add_action( 'businessx_main__header', 'businessx_top_sidebar_1', 10 ); // Footer sidebar #1
add_action( 'businessx_main__header', 'businessx_logo_display', 20, 1 ); // Add logo, text or image.
add_action( 'businessx_main__header', 'businessx_menu_main_area', 30 ); // Displays the main menu.
add_action( 'businessx_main__header', 'businessx_menu_actions_area', 40 ); // Wrapper for the right side menu
...
//add_action( 'businessx_header__action_btns_2', 'businessx_search_button', 0 ); // Action buttons - search
